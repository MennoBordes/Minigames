...
def show_go_screen():
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            #     waiting = False
        Important.button("Start", 150, 500, 100, 50, GREEN, WHITE, screen, BLACK, game_loop)
        Important.button("Quit", 550, 500, 100, 50, RED, WHITE, screen, BLACK, quitgame)
        pygame.display.flip()
...
def game_loop():
    ...
    while True:
        ...
        # distance_rem = DURATION - pygame.time.get_ticks()//1000
        distance_rem = DURATION - seconds
        if distance_rem == 0:
            neptune_game_completed = True
            quitgame()
        if distance_rem < 10:
            boost = 8
        # Update
        ...
        # draw_text(screen, 'Distance Remaining: ', 18, 64, 64)
        draw_text(screen, 'Distance Remaining: ' + str(distance_rem), 18, 128, 64)
