...
def main_intro():
    while True:
        ...
        text_s1, text_r1 = Important.text_objects("During the intergalactic war of 21XX you lost most of your friends.", small_text, color_white)
